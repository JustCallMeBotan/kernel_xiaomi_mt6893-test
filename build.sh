...
{
    rm -rf AnyKernel
    git clone --depth=1 https://github.com/JustCallMeBotan/AnyKernel33 -b $DEVICE AnyKernel
    ...
    cd AnyKernel
    zip -r9 4.14.336-Test-OSS-KERNEL-${DEVICE}-${SELINUX_MODE}-${DATE}-SUkiSU.zip * -x '*.git*' README.md *placeholder
    cd ../
}
